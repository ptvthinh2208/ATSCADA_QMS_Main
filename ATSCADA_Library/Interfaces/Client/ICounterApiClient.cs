...
namespace ATSCADA_Library.Interfaces.Client
{
    public interface ICounterApiClient
    {
        ...
        Task<bool> UpdateCallNextNumberAsync(int counterId, int currentOrderNumber);
        Task<bool> CreateTextCallCurrentNumber(string counterName,string code, int orderNumber, string nameClient);
